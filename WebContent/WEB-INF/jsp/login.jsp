...
<body>
	...
	<div id="logo"> 
	  <h1 class="hogo"><i>BUG管理系统登录</i></h1>
	</div> 
	<section class="stark-login">
  <form action="login.do" method="post">	
    <div id="fade-box">
      		<input type="text" name="username" id="username" placeholder="用户ID" required>
        	<input type="password" placeholder="密码" name="password" required>
            <input type="hidden" name="m" value="loginuser" />
            <button>登录</button>
            <span style="color: white;">没有账号？现在<a href="login.do?m=regestUser">《注册》</a></span>
     </div>
   </form>
      <div class="hexagons">
        <span>&#x2B22;</span>
